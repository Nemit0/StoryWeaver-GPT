...
if __name__ == "__main__":
    ...
    corpus = [' low lower newest widest']  # Note the leading space
    tokenizer.train(corpus, num_merges=10, verbose=True)
    print("Token Map:", tokenizer.token_map)
    print("BPE Codes:", tokenizer.bpe_codes)
    ...
    tokenizer2 = BytePairTokenizer()
    tokenizer2.load_model('bpe_model.json')
    decoded2 = tokenizer2.decode(encoded)
    print("Decoded from loaded model:", decoded2)
